...
public abstract class InventorySystem extends ModelObject {
    ...
    String getInventoryString() {
        String inventoryString = (list.isEmpty() ?
    ...
    String getLookItems() {
        String lookItems = (list.isEmpty() ? "" : list.stream().map(Item::getLookDescription).collect(Collectors.joining(System.lineSeparator())) + System.lineSeparator());
        return lookItems;
    } /* end getLookItems */
